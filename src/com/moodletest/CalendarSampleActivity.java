...
adb shell setprop log.tag.HttpTransport DEBUG
  ...
  private static final int CONTEXT_EVENT_ADD = 3;
  ...
  private final static int ADD_CALENDAR_EVENT_REQUEST = 4;
  ...
  public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
    ...
    menu.add(0, CONTEXT_EVENT_ADD, 0, R.string.eventadd);
  }
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    if (calendarIndex < adapter.getCount()) {
      ...
      switch (item.getItemId()) {
        ...
        case CONTEXT_EVENT_ADD:
          startAddCalendarEventActivity(calendarInfo);
          return true;
  ...
  private void startAddCalendarEventActivity(CalendarInfo calendarInfo) {
    ...
    attendees.add(new EventAttendee().setEmail("godalabhargav.reddy@gmail.com"));
    // ...
    event.setAttendees(attendees);
    Date now = new Date();
    Date startDate = new Date(now.getTime()+150000);
    ...
    List<EventReminder> rems = new ArrayList<EventReminder>();
    
    EventReminder evntrem = new EventReminder();
    evntrem.setMethod("sms");
    evntrem.setMinutes(2);
    rems.add(evntrem);
    //event.setRe
    rem.setOverrides(rems);
    event.setReminders(rem);
    new AsyncAddCalendarEvent(this, event,calendarInfo.id).execute();
  }
}
